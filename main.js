let res
  function shorturl() {
    let custom_key = "unknown"
    if(document.querySelector("#text").value==""){
        alert("Url cannot be empty!")
        return
    }
    if(document.querySelector("#customkey").value!=""){
        custom_key = document.querySelector("#customkey").value
    }
    ...
    fetch(window.location.pathname, {
      ...
      body: JSON.stringify({ url: document.querySelector("#text").value , custom: custom_key})
